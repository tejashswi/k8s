...
```bash
curl -sfL https://get.k3s.io | INSTALL_K3S_EXEC="server" sh -v
```
### Verify k8s binary
...
### for backup for step no 5 if its not working 
````bash
kubectl get nodes
kubectl get pods -A
````
